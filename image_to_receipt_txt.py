...
OUTPUT_PATH = Path("receipt.txt")


def usage() -> None:
    print("Usage:")
    print("  python image_to_receipt_txt.py <image_path>")
    print("\nExample:")
    print("  python image_to_receipt_txt.py training/sroie/SROIE2019/train/img/X51006555072.jpg")
...
def main() -> None:
    ...
    print("\nNext run:")
    print("  npx tsx receipt_parser.ts")
